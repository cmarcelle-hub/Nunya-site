...
const categories = [
  ...
  },
  {
    ...
    description:
      "Transmission de compétences, ateliers pratiques, accompagnement de projets et renforcement des capacités locales.",
    number: "02",
  },
  {
    ...
    description:
      "Actions de sensibilisation, autonomie, prévention, accompagnement social et valorisation du rôle des femmes.",
    number: "03",
  },
];
          ...
          <div className="container relative mx-auto max-w-6xl">
            ...
            >
              ...
              <h1 className="font-heading text-5xl md:text-7xl font-bold leading-tight mb-8">
                Agir pour l’éducation, la formation et l’autonomie locale.
              </h1>
              ...
              <p className="font-body text-lg md:text-xl text-sand/75 leading-relaxed max-w-3xl">
                ...
                accompagner les communautés et valoriser les initiatives de
                terrain.
              </p>
            </motion.div>
          </div>
